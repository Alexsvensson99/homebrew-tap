class Pkglift < Formula
  ...
  url "https://github.com/Alexsvensson99/PkgLift/releases/download/v0.8.0/pkglift-macos-arm64.tar.gz"
  sha256 "447871a7f21c58113ebf5682683d50d8e09beafc6a3eb43a535f8719d0f3f00a"
  license "MIT"
  ...
  test do
    assert_equal "0.8.0", shell_output("#{bin}/pkglift version").strip
